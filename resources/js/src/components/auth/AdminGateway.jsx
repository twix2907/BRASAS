  ...
  return (
    <div className="bienvenida-brasas" style={{ minHeight: '100vh', height: '100vh', width: '100vw', overflow: 'hidden', display: 'flex', flexDirection: 'column', background: '#232323', padding: 0, marginTop: 0 }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 0, padding: 24 }}>
        ...
        <div style={{ maxWidth: 380, width: '100%', background: '#1a1a1a', padding: 20, borderRadius: 12, border: '1px solid #ffd20330', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, minHeight: 0, overflowY: 'auto' }}>
          ...
          {step === 1 && (
            <form onSubmit={handleLogin} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ marginBottom: 14, width: '100%', maxWidth: 320, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <label style={{ color: '#fff', display: 'block', marginBottom: 6, fontSize: '0.9rem', textAlign: 'center' }}>Email del administrador:</label>
                <input 
                  type="email" 
                  value={email} 
              ...
              <div style={{ marginBottom: 20, width: '100%', maxWidth: 320, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <label style={{ color: '#fff', display: 'block', marginBottom: 6, fontSize: '0.9rem', textAlign: 'center' }}>Contraseña:</label>
                <input 
                  type="password" 
                  value={password} 
          ...
          {step === 3 && (
            <form onSubmit={handleVerifyCode} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ marginBottom: 20, width: '100%', maxWidth: 320, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <label style={{ color: '#fff', display: 'block', marginBottom: 6, fontSize: '0.9rem', textAlign: 'center' }}>Código SMS recibido:</label>
                <input 
                  type="text" 
                  value={smsCode} 
